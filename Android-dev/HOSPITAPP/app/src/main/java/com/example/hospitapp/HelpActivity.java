...
public class HelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String hospitappHomeIntroText = "Home provides a simple interface for the user to check what orders have been placed, and have not yet been linked to a provider. By pressing the button \"Providers\", the user must enter 2 IDs. The first ID corresponds to an order placed by the user. By pressing \"Search ID\", you will get a list of all providers who are capable of preparing said order. You can then choose one of the providers, enter their corresponding ID and then click \"Link\". This will move the order to Linked.";
