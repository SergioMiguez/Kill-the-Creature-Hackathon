...
public class ListCompletedAdapter  extends RecyclerView.Adapter<ListCompletedAdapter.OrderViewHolder> implements View.OnClickListener{
    ...
    public ListCompletedAdapter(ArrayList<Order> listOfOrdersSent) {
