...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Floating button which is in charge of showing the rest of the buttons.
     */
    private FloatingActionButton fabThree;
    /**
     * Floating button which is in charge of closing the rest of the buttons.
     */
    private FloatingActionButton fabCloseThree;
    /**
    ...
    public void openAdd() {
        ...
        fabCloseThree = findViewById(R.id.addFabButton);
        fabCloseThree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                try {
                    showFab(fabThree);
                    hideFab(fabCloseThree);
                    hideFab(fabMaterial);
                    hideFab(fabHelp);
                    finalize();
                } catch (Throwable throwable) {
